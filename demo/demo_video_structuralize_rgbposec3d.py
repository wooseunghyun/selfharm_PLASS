...
def main():
    ...
    #필요한 루트
    # args.video = '/workspace/police_lab/mmaction2_mhncity/demo/video/CH1_1_10-1of2_2.mp4'
    # args.out_filename = '/workspace/police_lab/mmaction2_mhncity/demo/result/CH1_1_10-1of2_2_out.mp4'

    args.video = '/workspace/police_lab/mmaction2/demo/demo.mp4'
    args.out_filename = '/workspace/police_lab/mmaction2/demo/result/demo.mp4'

    args.rgb_stdet_config = '/workspace/police_lab/mmaction2/work_dirs/demo_rgbposec3d/rgb_only_custom.py'
    args.rgb_stdet_checkpoint = '/workspace/police_lab/mmaction2/work_dirs/demo_rgbposec3d/rgb_best_acc_top1_epoch_17.pth'
    args.skeleton_stdet_checkpoint = '/workspace/police_lab/mmaction2/work_dirs/demo_rgbposec3d/pose_only_custom.py'
    args.skeleton_checkpoint = '/workspace/police_lab/mmaction2/work_dirs/demo_rgbposec3d/pose_best_acc_top1_epoch_17.pth'
    
    #사람 탐지
    args.det_config = '/workspace/police_lab/mmaction2/demo/demo_configs/faster-rcnn_r50_fpn_2x_coco_infer.py'
    ...
    #스켈레톤 추출
    args.pose_config = '/workspace/police_lab/mmaction2/demo/demo_configs/td-hm_hrnet-w32_8xb64-210e_coco-256x192_infer.py'
    ...
    args.label_map_stdet = '/workspace/police_lab/mmaction2/demo/label_map_c2_stdet.txt'
    args.label_map = '/workspace/police_lab/mmaction2/demo/label_map_c2.txt'


    tmp_dir = tempfile.TemporaryDirectory()

    #여기에 이미지를 받아와서 돌리면 될것 같은데
